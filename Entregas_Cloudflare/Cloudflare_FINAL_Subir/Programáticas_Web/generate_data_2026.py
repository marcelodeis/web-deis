...
print("=== Generating programaticas_data_2026.js ===")

oc_path = os.path.join(BASE_DIR, "2026", "Programáticas_Ocurrencia_2026.csv")
re_path = os.path.join(BASE_DIR, "2026", "Programáticas_Residencia_2026.csv")
...
out_file_js = r"c:\Antigravity IDE\WEB DEIS\Programáticas_Web\programaticas_data_2026.js"
out_file_json = r"c:\Antigravity IDE\WEB DEIS\Programáticas_Web\programaticas_data_2026.json"

with open(out_file_js, 'w', encoding='utf-8') as f:
    f.write('var PROGRAMATICAS_DATA_2026 = ')
