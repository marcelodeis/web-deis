...
function updateRankings(data, filter) {
    ...
    if (worstEl && stats.length > 0) {
        ...
        let worstG = worst.g.replace('P. de salud:', 'Prestador:').replace('Personas mayores de 60 años y más (año 1966)', 'Personas de 60 años y más (nacidos en 1966 o antes)');
