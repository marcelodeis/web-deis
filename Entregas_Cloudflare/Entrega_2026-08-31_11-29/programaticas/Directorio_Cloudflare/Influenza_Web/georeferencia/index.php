<?php
// index.php - Dashboard con carga dinámica vía API PHP
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<script>
const API_URL = 'api/establecimientos.php';
...
async function init(){
  try{
    ...
    document.getElementById('list-container').innerHTML = '<div style="padding:1rem;color:var(--alert)"><strong>Error:</strong> No se pudieron cargar los datos.<br><small>'+e.message+'</small></div>';
    return;
  }
  populateFilters();
  applyFilters();
