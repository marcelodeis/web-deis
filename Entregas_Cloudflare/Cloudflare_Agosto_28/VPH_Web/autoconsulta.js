 ...
 * â•‘   AUTOCONSULTA DE ESTADO DE VACUNACIÃ“N - VPH             â•‘
 ...
 * cruza contra VPH_RUNS_INDEX (Set pre-generado),
 * y genera un Excel de salida con columna VPH (SI/NO).
 *
 * Dependencias:
 *   - SheetJS (xlsx-js-style) â€” ya cargado en el proyecto
 *   - VPH_RUNS_INDEX.js â€” Set con RUNs vacunados
 */
...
const Autoconsulta = {
    ...
    _procesarWorkbook(arrayBuffer) {
        ...
        // Verificar Ã­ndice
        if (typeof VPH_RUNS_INDEX === 'undefined') {
...
× ${stats.no} personas sin registro de vacuna Influenza 2026.">
    ...
    /**
     * Descarga el Excel procesado con la columna VPH.
     */
    downloadResult() {
        // Close dropdown
        const menu = document.getElementById('exportDropdownMenu');
        ...
        try {
            ...
            const outputName = `${baseName}_AUTOCONSULTA_VPH.xlsx`;
