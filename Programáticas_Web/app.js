...
function switchYear(year) {
    ...
    if (reportDate) {
        reportDate.innerHTML = `<i class="fas fa-calendar-alt"></i> Fuente: DEIS-MINSAL, Fecha de corte: ${DATA.fecha_actualizacion}`;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('reportDate').innerHTML = 
        `<i class="fas fa-calendar-alt"></i> Fuente: DEIS-MINSAL, Fecha de corte: ${DATA.fecha_actualizacion}`;
